    ...
    <header className="bg-white h-16 border-b border-gray-200 flex items-center px-4 sticky top-0 z-10">
      <div className="flex items-center">
        ...
        <div className="flex items-center">
          ...
          <h1 className="text-xl font-medium ml-2 text-gray-800">Drive</h1>
        </div>
      </div>
      
      <div className={`mx-auto max-w-2xl w-full relative transition-all ${
        isSearchFocused ? 'bg-white shadow-md' : 'bg-gray-100'
      } rounded-full flex items-center px-4 py-2 md:max-w-lg`}>
      ...
      <div className="flex items-center ml-4">
        ...
        <button className="p-2 rounded-full hover:bg-gray-100 transition-colors ml-1">
          <Settings size={20} className="text-gray-600" />
        </button>
        <button className="p-2 rounded-full hover:bg-gray-100 transition-colors ml-1 relative">
